...
class SidebarItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        isSelected ? Container(margin: EdgeInsets.only(right: screenWidth*0.003),height: screenHeight*0.04,width: screenWidth*0.005, color: youtubeColor,) : Container(margin: EdgeInsets.only(right: 0.8.w),height: 1.5.h,width: 5),
        Container(
