                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: 26.0.w,
                              child: InputField(labelText: "Enter Ras", controller: controller.rasController, keyboardType: TextInputType.text)),
                        ],
                      ),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          ...
                          Container(
                              width: 26.0.w,
                              child: InputField(labelText: "Enter Gan", controller: controller.ganController, keyboardType: TextInputType.text)),
                        ],
                      ),
                    ],
                  ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Builder(builder: (buttonContext){
                            return Obx(()=>HollowButton(title: controller.selectedBloodGroup.value, onTap: (){controller.showPopUp(buttonContext);}, height: 3.0.h, width: 20.0.w));
                          }),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            width: 33.8.w,
                              child: InputField(labelText: "Enter Education", controller: controller.educationController, keyboardType: TextInputType.text)),
                        ],
                      ),
                    ],
                  ),
